...
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAwMDAsIm5hbWUiOiJVc2VyICMxIiwibWFpbCI6InVzZXJAbWFpbC5jb20ifQ.sxUN_92Ko2jYDagGHnUv6urmtNNnhdolmL87NrgfrCg';
...
test('Deve listar apenas as transfêrencias do usuários', () => {
...
test('Deve inserir uma transferência comm sucesso', () => {
...
describe('Ao salvar uma transferencia válida', () => {
  ...
  test('Ambas devem referenciar a trasnferência que a originou', () => {
...
test('Deve retornar uma transfêrencia por Id', () => {
...
describe('Ao remover transfêrencia', () => { 
    ...
    test('As transações equivalentes devem ter sido removidas', () => {
